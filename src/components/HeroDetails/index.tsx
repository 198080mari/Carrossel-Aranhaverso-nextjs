...
export default function HeroDetails({ data }: IProps) {
  ...
  return (
    <div className={quicksand.className}>
      <h2 className={`${spidermanFont.className} ${styles.title}`}>
      ...
      <div className={styles.details}>
        ...
        <table className={styles.table}>
          <tbody>
            <tr>
              <td className={styles.table}>Nome completo</td>
              <td>{details.fullName}</td>
            </tr>
            <tr>
              <td className={styles.table}>Data de nascimento</td>
              <td>{new Date(details.birthday).toLocaleDateString("pt-BR")}</td>
            </tr>
            <tr>
              <td className={styles.table}>Terra natal</td>
              <td>{details.homeland}</td>
            </tr>
            <tr>
              <td className={styles.table}>Altura</td>
              <td>{details.height.toFixed(2)}m</td>
            </tr>
            <tr>
              <td className={styles.table}>Peso</td>
      ...
      <div className={styles.details}>
        <h2>{styles.subtitle}Primeira aparição</h2>
        <Image
